          ...
          <section className="rounded-[34px] border border-[#ddd7cc] bg-[#fbfaf6] p-6 shadow-[0_18px_52px_rgba(74,59,39,0.08)] sm:p-8">
            ...
            <div className="mt-6 grid gap-5">
              <label className="block">
                <span className="mb-2 block text-[11px] uppercase tracking-[0.28em] text-[#787365]">Title / 标题</span>
                <input
              ...
              <div className="grid gap-5 md:grid-cols-[minmax(0,1fr)_180px]">
                <label className="block">
                  <span className="mb-2 block text-[11px] uppercase tracking-[0.28em] text-[#787365]">Slug / 路径名</span>
                  <input
                    className="w-full rounded-2xl border border-[#d9d4ca] bg-white px-4 py-3 text-sm text-[#45453f] outline-none transition focus:border-[#8a9680]"
                    onChange={(event) => {
                      setSlugTouched(true);
                ...
                <label className="block">
                  <span className="mb-2 block text-[11px] uppercase tracking-[0.28em] text-[#787365]">Status / 状态</span>
                  <select
                    className="w-full rounded-2xl border border-[#d9d4ca] bg-white px-4 py-3 text-sm text-[#45453f] outline-none transition focus:border-[#8a9680]"
              ...
              <label className="block">
                <span className="mb-2 block text-[11px] uppercase tracking-[0.28em] text-[#787365]">Excerpt / 摘要</span>
                <textarea
              ...
              <label className="block">
                <span className="mb-2 block text-[11px] uppercase tracking-[0.28em] text-[#787365]">Cover URL / 封面链接</span>
                <input
                  className="w-full rounded-2xl border border-[#d9d4ca] bg-white px-4 py-3 text-sm text-[#45453f] outline-none transition focus:border-[#8a9680]"
              ...
              <label className="block">
                <span className="mb-2 block text-[11px] uppercase tracking-[0.28em] text-[#787365]">Markdown / 正文</span>
                <textarea
